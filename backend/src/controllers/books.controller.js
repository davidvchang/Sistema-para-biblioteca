...
export const postBook = async (req, res) => {
    ...
    try {
        await pool.query("INSERT INTO libros (titulo, autor, isbn, genero, precio, stock, fecha_publicacion, estado) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)", [titulo, autor, isbn, genero, precio, stock, fecha_publicacion, estado])
